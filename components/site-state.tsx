...
const STORAGE_KEY = "earth-spas-multipage-plan-v5";
const LEGACY_KEYS = ["earth-spas-multipage-plan-v4", "earth-spas-multipage-plan-v3", "earth-spas-multipage-plan-v2", "earth-spas-multipage-plan-v1", "earth-spas-choice-guide-v5"];
